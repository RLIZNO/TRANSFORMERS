(function (){
	'use strict';
	angular
	.module('transactionAffiliateModule')
	.controller('transactionAffiliateController', transactionAffiliateController);

	 //Inyeccion de dependencias
	transactionAffiliateController.$inject = [
	 	'sweet',
	 	'$state',
	 	'URL',
	...
	function transactionAffiliateController(
		sweet,
		$state,
		URL,
        validTransactionAffiliate,
    ...
    $rootScope,
        ...
        function modalCancel() {
            sweet.show({
                ...
                $timeout(function () {
                    ...
                    var afiliados = false;
                    localStorage.setItem("afiliados", afiliados);
         ...
         function addJobsData(){ 
             ...
             if(vm.formProductMantenimentNew.$valid){
                   ...
                   if (vm.viewModelTransaction.status == vm.optStatus[1].valValue) {
                    ...
                    addTableAffliateService.InsertAffiliate(jsonUpdate);
                    tablaBin()
                    vm.viewModelTransitionNew = {};
        ...
        */
         ...
         function tablaBin() {
            validTransactionAffiliate.getvalidaTransitionAffiliate().then(                
                function (response) {
                    $timeout(function(){
